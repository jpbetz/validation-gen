...
type Struct struct {
	...
	// +k8s:subfield(stringField)=+validateFalse="subfield Struct.StructField.StringField 1"
	// +k8s:subfield(stringField)=+validateFalse="subfield Struct.StructField.StringField 2"
	...
	// +k8s:subfield(stringField)=+validateFalse="subfield Struct.StructPtrField.StringField 1"
	// +k8s:subfield(stringField)=+validateFalse="subfield Struct.StructPtrField.StringField 2"
