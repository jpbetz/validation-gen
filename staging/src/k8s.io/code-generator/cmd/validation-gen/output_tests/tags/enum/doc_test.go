...
func Test(t *testing.T) {
	...
	st.Value(&Struct{
		...
		field.NotSupported(field.NewPath("enum0Field"), Enum0(""), ([]Enum0)(nil)),
	...
	st.Value(&Struct{
		...
		field.NotSupported(field.NewPath("enum0Field"), Enum0(""), ([]Enum0)(nil)),
		field.NotSupported(field.NewPath("enum0PtrField"), ptr.To(Enum0("")), ([]Enum0)(nil)),
	})
	...
	st.Value(&Struct{
		...
		field.NotSupported(field.NewPath("enum0Field"), Enum0("x"), ([]Enum0)(nil)),
		field.NotSupported(field.NewPath("enum0PtrField"), ptr.To(Enum0("x")), ([]Enum0)(nil)),
		field.NotSupported(field.NewPath("enum1Field"), Enum1("x"), []Enum1{E1V1}),
		field.NotSupported(field.NewPath("enum1PtrField"), ptr.To(Enum1("x")), []Enum1{E1V1}),
		field.NotSupported(field.NewPath("enum2Field"), Enum2("x"), []Enum2{E2V1, E2V2}),
		field.NotSupported(field.NewPath("enum2PtrField"), ptr.To(Enum2("x")), []Enum2{E2V1, E2V2}),
	})
}
