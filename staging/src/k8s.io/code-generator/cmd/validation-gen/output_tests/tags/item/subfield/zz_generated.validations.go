...
func Validate_Struct(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *Struct) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []RatchetItem, oldValueCorrelated bool) (errs field.ErrorList) {
			...
			// lists with map semantics require unique keys
			{
				var match = func(a RatchetItem, b RatchetItem) bool { return a.Key == b.Key }
				errs = append(errs, validate.Unique(ctx, op, fldPath, obj, oldObj, match)...)
			}
			func() { // cohort {"key": "ratchet"}
				{
					var match = func(item *RatchetItem) bool { return item.Key == "ratchet" }
					errs = append(errs, validate.SliceItem(ctx, op, fldPath, obj, oldObj, match, validate.DirectEqual, func(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *RatchetItem) field.ErrorList {
