...
type Struct struct {
	...
	// +k8s:NEQString("disallowed-string")
	StringField string `json:"stringField"`

	// +k8s:NEQString("disallowed-pointer")
	StringPtrField *string `json:"stringPtrField"`

	// +k8s:NEQString("disallowed-typedef")
	StringTypedefField StringType `json:"stringTypedefField"`

	// +k8s:NEQString("disallowed-typedef-pointer")
...
// +k8s:NEQString("disallowed-on-type")
