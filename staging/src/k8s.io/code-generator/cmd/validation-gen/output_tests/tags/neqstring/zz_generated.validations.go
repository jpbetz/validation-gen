...
func Validate_Struct(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *Struct) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *string) (errs field.ErrorList) {
			...
			errs = append(errs, validate.NEQString(ctx, op, fldPath, obj, oldObj, "disallowed-string")...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *string) (errs field.ErrorList) {
			...
			errs = append(errs, validate.NEQString(ctx, op, fldPath, obj, oldObj, "disallowed-pointer")...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *StringType) (errs field.ErrorList) {
			...
			errs = append(errs, validate.NEQString(ctx, op, fldPath, obj, oldObj, "disallowed-typedef")...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *StringType) (errs field.ErrorList) {
			...
			errs = append(errs, validate.NEQString(ctx, op, fldPath, obj, oldObj, "disallowed-typedef-pointer")...)
			return
...
func Validate_ValidatedStringType(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *ValidatedStringType) (errs field.ErrorList) {
	...
	errs = append(errs, validate.NEQString(ctx, op, fldPath, obj, oldObj, "disallowed-on-type")...)
