...
func Validate_Struct(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *Struct) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *int) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EqOneOf(ctx, op, fldPath, obj, oldObj, []int{1, 2, 3})...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *int16) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EqOneOf(ctx, op, fldPath, obj, oldObj, []int16{1, 2, 3})...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *int32) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EqOneOf(ctx, op, fldPath, obj, oldObj, []int32{1, 2, 3})...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *int64) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EqOneOf(ctx, op, fldPath, obj, oldObj, []int64{1, 2, 3})...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *uint) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EqOneOf(ctx, op, fldPath, obj, oldObj, []uint{1, 2, 3})...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *uint16) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EqOneOf(ctx, op, fldPath, obj, oldObj, []uint16{1, 2, 3})...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *uint32) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EqOneOf(ctx, op, fldPath, obj, oldObj, []uint32{1, 2, 3})...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *int) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EqOneOf(ctx, op, fldPath, obj, oldObj, []int{-1, -2, -3})...)
			return
		}(fldPath.Child("intWithNegativeField"), &obj.IntWithNegativeField, safe.Field(oldObj, func(oldObj *Struct) *int { return &oldObj.IntWithNegativeField }))...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *IntType) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EqOneOf(ctx, op, fldPath, obj, oldObj, []IntType{IntType(1), IntType(2), IntType(3)})...)
			return
	...
	// field Struct.ValidatedTypedefIntField
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *ValidatedIntType) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("validatedTypedefIntField"), &obj.ValidatedTypedefIntField, safe.Field(oldObj, func(oldObj *Struct) *ValidatedIntType { return &oldObj.ValidatedTypedefIntField }))...)
...
func Validate_ValidatedIntType(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *ValidatedIntType) (errs field.ErrorList) {
	...
	errs = append(errs, validate.EqOneOf(ctx, op, fldPath, obj, oldObj, []ValidatedIntType{ValidatedIntType(1), ValidatedIntType(2), ValidatedIntType(3)})...)
