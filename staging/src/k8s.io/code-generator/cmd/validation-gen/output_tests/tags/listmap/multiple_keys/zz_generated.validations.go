...
func Validate_Struct(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *Struct) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []OtherStruct) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EachSliceValComparable(ctx, op, fldPath, obj, oldObj, func(a OtherStruct, b OtherStruct) bool {
				return a.Key1Field == b.Key1Field && a.Key2Field == b.Key2Field
			}, false, validate.ImmutableByReflect)...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []OtherTypedefStruct) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EachSliceValComparable(ctx, op, fldPath, obj, oldObj, func(a OtherTypedefStruct, b OtherTypedefStruct) bool {
				return a.Key1Field == b.Key1Field && a.Key2Field == b.Key2Field
			}, false, validate.ImmutableByReflect)...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []OtherStruct) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EachSliceValComparable(ctx, op, fldPath, obj, oldObj, func(a OtherStruct, b OtherStruct) bool {
				return a.Key1Field == b.Key1Field && a.Key2Field == b.Key2Field
			}, false, func(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *OtherStruct) field.ErrorList {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []NonComparableStruct) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EachSliceVal(ctx, op, fldPath, obj, oldObj, func(a NonComparableStruct, b NonComparableStruct) bool {
				return a.Key1Field == b.Key1Field && a.Key2Field == b.Key2Field
			}, false, func(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *NonComparableStruct) field.ErrorList {
