...
func Validate_UpdateTestStruct(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *UpdateTestStruct) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *string) (errs field.ErrorList) {
			...
			// call field-attached validations
			earlyReturn := false
			if e := validate.NoUnsetValue(ctx, op, fldPath, obj, oldObj); len(e) != 0 {
				errs = append(errs, e...)
				earlyReturn = true
			}
			if earlyReturn {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *TestStruct) (errs field.ErrorList) {
			...
			// call field-attached validations
			earlyReturn := false
			if e := validate.NoModifyStruct(ctx, op, fldPath, obj, oldObj); len(e) != 0 {
				errs = append(errs, e...)
				earlyReturn = true
			}
			if earlyReturn {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *string) (errs field.ErrorList) {
			...
			// call field-attached validations
			earlyReturn := false
			if e := validate.NoSetPointer(ctx, op, fldPath, obj, oldObj); len(e) != 0 {
				errs = append(errs, e...)
				earlyReturn = true
			}
			if earlyReturn {
