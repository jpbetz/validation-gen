...
func Validate_HasFieldVal(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *HasFieldVal) (errs field.ErrorList) {
	// field HasFieldVal.S
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *string, parent *HasFieldVal) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, false, "field HasFieldVal.S")...)
			return
		}(fldPath.Child("s"), &obj.S, safe.Field(oldObj, func(oldObj *HasFieldVal) *string { return &oldObj.S }), obj)...)
...
func Validate_T1(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *T1) (errs field.ErrorList) {
	...
	// field T1.HasTypeVal
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *HasTypeVal, parent *T1) (errs field.ErrorList) {
			errs = append(errs, Validate_HasTypeVal(ctx, op, fldPath, obj, oldObj)...)
			return
		}(fldPath.Child("hasTypeVal"), &obj.HasTypeVal, safe.Field(oldObj, func(oldObj *T1) *HasTypeVal { return &oldObj.HasTypeVal }), obj)...)

	// field T1.HasFieldVal
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *HasFieldVal, parent *T1) (errs field.ErrorList) {
			errs = append(errs, Validate_HasFieldVal(ctx, op, fldPath, obj, oldObj)...)
			return
		}(fldPath.Child("hasFieldVal"), &obj.HasFieldVal, safe.Field(oldObj, func(oldObj *T1) *HasFieldVal { return &oldObj.HasFieldVal }), obj)...)

	// field T1.HasNoVal has no validation

	// field T1.HasNoValFieldVal
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *HasNoVal, parent *T1) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, false, "field T1.HasNoValFieldVal")...)
			return
		}(fldPath.Child("hasNoValFieldVal"), &obj.HasNoValFieldVal, safe.Field(oldObj, func(oldObj *T1) *HasNoVal { return &oldObj.HasNoValFieldVal }), obj)...)
