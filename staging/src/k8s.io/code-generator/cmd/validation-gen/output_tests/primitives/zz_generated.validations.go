...
func Validate_T1(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *T1) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *int, parent *T1) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("i"), &obj.I, safe.Field(oldObj, func(oldObj *T1) *int { return &oldObj.I }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *bool, parent *T1) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("b"), &obj.B, safe.Field(oldObj, func(oldObj *T1) *bool { return &oldObj.B }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *float64, parent *T1) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("f"), &obj.F, safe.Field(oldObj, func(oldObj *T1) *float64 { return &oldObj.F }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *T2, parent *T1) (errs field.ErrorList) {
			errs = append(errs, Validate_T2(ctx, op, fldPath, obj, oldObj)...)
			return
		}(fldPath.Child("anothert2"), &obj.AnotherT2, safe.Field(oldObj, func(oldObj *T1) *T2 { return &oldObj.AnotherT2 }), obj)...)
...
func Validate_T2(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *T2) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *int, parent *T2) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("i"), &obj.I, safe.Field(oldObj, func(oldObj *T2) *int { return &oldObj.I }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *bool, parent *T2) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("b"), &obj.B, safe.Field(oldObj, func(oldObj *T2) *bool { return &oldObj.B }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *float64, parent *T2) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("f"), &obj.F, safe.Field(oldObj, func(oldObj *T2) *float64 { return &oldObj.F }), obj)...)
