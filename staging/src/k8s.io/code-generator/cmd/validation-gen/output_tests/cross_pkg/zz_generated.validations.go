...
func Validate_T1(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *T1) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *primitives.T1, parent *T1) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("primitivest1"), &obj.PrimitivesT1, safe.Field(oldObj, func(oldObj *T1) *primitives.T1 { return &oldObj.PrimitivesT1 }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *primitives.T1, parent *T1) (errs field.ErrorList) {
			...
			errs = append(errs, primitives.Validate_T1(ctx, op, fldPath, obj, oldObj)...)
			return
		}(fldPath.Child("primitivest1Ptr"), obj.PrimitivesT1Ptr, safe.Field(oldObj, func(oldObj *T1) *primitives.T1 { return oldObj.PrimitivesT1Ptr }), obj)...)

	// field T1.PrimitivesT2
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *primitives.T2, parent *T1) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("primitivest2"), &obj.PrimitivesT2, safe.Field(oldObj, func(oldObj *T1) *primitives.T2 { return &oldObj.PrimitivesT2 }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *primitives.T1, parent *T1) (errs field.ErrorList) {
			...
			errs = append(errs, primitives.Validate_T1(ctx, op, fldPath, obj, oldObj)...)
			return
		}(fldPath.Child("primitivest2Ptr"), obj.PrimitivesT2Ptr, safe.Field(oldObj, func(oldObj *T1) *primitives.T1 { return oldObj.PrimitivesT2Ptr }), obj)...)

	// field T1.PrimitivesT3
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *primitives.T3, parent *T1) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, true, "field T1.PrimitivesT3")...)
			return
		}(fldPath.Child("primitivest3"), &obj.PrimitivesT3, safe.Field(oldObj, func(oldObj *T1) *primitives.T3 { return &oldObj.PrimitivesT3 }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *primitives.T1, parent *T1) (errs field.ErrorList) {
			...
			errs = append(errs, primitives.Validate_T1(ctx, op, fldPath, obj, oldObj)...)
			return
		}(fldPath.Child("primitivest3Ptr"), obj.PrimitivesT3Ptr, safe.Field(oldObj, func(oldObj *T1) *primitives.T1 { return oldObj.PrimitivesT3Ptr }), obj)...)

	// field T1.TypedefsE1
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *typedefs.E1, parent *T1) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("typedefse1"), &obj.TypedefsE1, safe.Field(oldObj, func(oldObj *T1) *typedefs.E1 { return &oldObj.TypedefsE1 }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *typedefs.E1, parent *T1) (errs field.ErrorList) {
			...
			errs = append(errs, typedefs.Validate_E1(ctx, op, fldPath, obj, oldObj)...)
			return
		}(fldPath.Child("typedefse1Ptr"), obj.TypedefsE1Ptr, safe.Field(oldObj, func(oldObj *T1) *typedefs.E1 { return oldObj.TypedefsE1Ptr }), obj)...)

	// field T1.TypedefsE2
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *typedefs.E2, parent *T1) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("typedefse2"), &obj.TypedefsE2, safe.Field(oldObj, func(oldObj *T1) *typedefs.E2 { return &oldObj.TypedefsE2 }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *typedefs.E2, parent *T1) (errs field.ErrorList) {
			...
			errs = append(errs, typedefs.Validate_E2(ctx, op, fldPath, obj, oldObj)...)
			return
		}(fldPath.Child("typedefse2Ptr"), obj.TypedefsE2Ptr, safe.Field(oldObj, func(oldObj *T1) *typedefs.E2 { return oldObj.TypedefsE2Ptr }), obj)...)

	// field T1.TypedefsE3
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *typedefs.E3, parent *T1) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("typedefse3"), &obj.TypedefsE3, safe.Field(oldObj, func(oldObj *T1) *typedefs.E3 { return &oldObj.TypedefsE3 }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *typedefs.E3, parent *T1) (errs field.ErrorList) {
			...
			errs = append(errs, typedefs.Validate_E3(ctx, op, fldPath, obj, oldObj)...)
			return
		}(fldPath.Child("typedefse3Ptr"), obj.TypedefsE3Ptr, safe.Field(oldObj, func(oldObj *T1) *typedefs.E3 { return oldObj.TypedefsE3Ptr }), obj)...)

	// field T1.TypedefsE4
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *typedefs.E4, parent *T1) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("typedefse4"), &obj.TypedefsE4, safe.Field(oldObj, func(oldObj *T1) *typedefs.E4 { return &oldObj.TypedefsE4 }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *typedefs.E4, parent *T1) (errs field.ErrorList) {
			...
			errs = append(errs, typedefs.Validate_E4(ctx, op, fldPath, obj, oldObj)...)
			return
		}(fldPath.Child("typedefse4Ptr"), obj.TypedefsE4Ptr, safe.Field(oldObj, func(oldObj *T1) *typedefs.E4 { return oldObj.TypedefsE4Ptr }), obj)...)

	// field T1.OtherString
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *other.StringType, parent *T1) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, true, "field T1.OtherString")...)
			return
		}(fldPath.Child("otherString"), &obj.OtherString, safe.Field(oldObj, func(oldObj *T1) *other.StringType { return &oldObj.OtherString }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *other.StringType, parent *T1) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("otherStringPtr"), obj.OtherStringPtr, safe.Field(oldObj, func(oldObj *T1) *other.StringType { return oldObj.OtherStringPtr }), obj)...)

	// field T1.OtherInt
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *other.IntType, parent *T1) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, true, "field T1.OtherInt")...)
			return
		}(fldPath.Child("otherInt"), &obj.OtherInt, safe.Field(oldObj, func(oldObj *T1) *other.IntType { return &oldObj.OtherInt }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *other.IntType, parent *T1) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("otherIntPtr"), obj.OtherIntPtr, safe.Field(oldObj, func(oldObj *T1) *other.IntType { return oldObj.OtherIntPtr }), obj)...)

	// field T1.OtherStruct
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *other.StructType, parent *T1) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, true, "field T1.OtherStruct")...)
			return
		}(fldPath.Child("otherStruct"), &obj.OtherStruct, safe.Field(oldObj, func(oldObj *T1) *other.StructType { return &oldObj.OtherStruct }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *other.StructType, parent *T1) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("otherStructPtr"), obj.OtherStructPtr, safe.Field(oldObj, func(oldObj *T1) *other.StructType { return oldObj.OtherStructPtr }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []other.StructType, parent *T1) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("sliceOfOtherStruct"), obj.SliceOfOtherStruct, safe.Field(oldObj, func(oldObj *T1) []other.StructType { return oldObj.SliceOfOtherStruct }), obj)...)
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []other.StructType, parent *T1) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("listMapOfOtherStruct"), obj.ListMapOfOtherStruct, safe.Field(oldObj, func(oldObj *T1) []other.StructType { return oldObj.ListMapOfOtherStruct }), obj)...)

	// field T1.MapOfOtherStringToOtherStruct
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj map[other.StringType]other.StructType, parent *T1) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("mapOfOtherStringToOtherStruct"), obj.MapOfOtherStringToOtherStruct, safe.Field(oldObj, func(oldObj *T1) map[other.StringType]other.StructType { return oldObj.MapOfOtherStringToOtherStruct }), obj)...)
