...
func Validate_T1(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *T1) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []other.StructType) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EachSliceValComparable(ctx, op, fldPath, obj, oldObj, validate.SemanticDeepEqual, true, func(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *other.StructType) field.ErrorList {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []other.StructType) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EachSliceValComparable(ctx, op, fldPath, obj, oldObj, func(a other.StructType, b other.StructType) bool { return a.StringField == b.StringField }, false, func(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *other.StructType) field.ErrorList {
				return validate.FixedResult(ctx, op, fldPath, obj, oldObj, true, "field T1.SliceOfOtherStruct values")
			})...)
			return
