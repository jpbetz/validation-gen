...
func Validate_T1(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *T1) (errs field.ErrorList) {
	...
	// field T1.PT1
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *T1, parent *T1) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("pt1"), obj.PT1, safe.Field(oldObj, func(oldObj *T1) *T1 { return oldObj.PT1 }), obj)...)
...
func Validate_T2(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *T2) (errs field.ErrorList) {
	...
	// field T2.PT1
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *T1, parent *T2) (errs field.ErrorList) {
			if e := validate.OptionalPointer(ctx, op, fldPath, obj, oldObj); len(e) != 0 {
				return // do not proceed
			}
			...
			errs = append(errs, Validate_T1(ctx, op, fldPath, obj, oldObj)...)
			return
		}(fldPath.Child("pt1"), obj.PT1, safe.Field(oldObj, func(oldObj *T2) *T1 { return oldObj.PT1 }), obj)...)

	// field T2.PT2
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *T2, parent *T2) (errs field.ErrorList) {
			if e := validate.OptionalPointer(ctx, op, fldPath, obj, oldObj); len(e) != 0 {
				return // do not proceed
			}
			...
			errs = append(errs, Validate_T2(ctx, op, fldPath, obj, oldObj)...)
			return
		}(fldPath.Child("pt2"), obj.PT2, safe.Field(oldObj, func(oldObj *T2) *T2 { return oldObj.PT2 }), obj)...)
