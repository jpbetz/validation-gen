...
func Validate_StructSlice(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *StructSlice) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []S) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EachSliceValComparable(ctx, op, fldPath, obj, oldObj, validate.DirectEqual, true, func(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *S) field.ErrorList {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj MySlice) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EachSliceValComparable(ctx, op, fldPath, obj, oldObj, validate.DirectEqual, true, func(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *int) field.ErrorList {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []DirectComparableStruct) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EachSliceValComparable(ctx, op, fldPath, obj, oldObj, validate.SemanticDeepEqual, true, func(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *DirectComparableStruct) field.ErrorList {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []NonDirectComparableStruct) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EachSliceVal(ctx, op, fldPath, obj, oldObj, validate.SemanticDeepEqual, true, func(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *NonDirectComparableStruct) field.ErrorList {
				return validate.FixedResult(ctx, op, fldPath, obj, oldObj, false, "field SliceNonComparableStructField[*]")
			})...)
			errs = append(errs, validate.EachSliceVal(ctx, op, fldPath, obj, oldObj, validate.SemanticDeepEqual, true, Validate_NonDirectComparableStruct)...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []DirectComparableStructWithKey) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EachSliceValComparable(ctx, op, fldPath, obj, oldObj, func(a DirectComparableStructWithKey, b DirectComparableStructWithKey) bool { return a.Key == b.Key }, false, func(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *DirectComparableStructWithKey) field.ErrorList {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []NonComparableStructWithKey) (errs field.ErrorList) {
			...
			errs = append(errs, validate.EachSliceVal(ctx, op, fldPath, obj, oldObj, func(a NonComparableStructWithKey, b NonComparableStructWithKey) bool { return a.Key == b.Key }, false, func(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *NonComparableStructWithKey) field.ErrorList {
